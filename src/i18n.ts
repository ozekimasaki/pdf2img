...
export const i18n: Record<Lang, {
  ...
  en: {
    title: 'Img2PDF',
    subtitle: 'Convert JPG / PNG / GIF / WebP to PDF (single or merge)',
    mode_merge: 'Merge',
    mode_single: 'Single',
    drop_prompt: 'Drag & drop here or click to select',
    drop_supported: 'Supported: JPG, PNG, GIF, WebP',
    ...
    tip3: 'GIF / WebP are imported as still images (first frame).',
  ...
  ja: {
    title: 'Img2PDF',
    subtitle: 'JPG / PNG / GIF / WebP を PDF に変換（単体・結合）',
    mode_merge: '複数結合',
    mode_single: '単体変換',
    drop_prompt: 'ここにドラッグ&ドロップ または クリックして選択',
    drop_supported: '対応: JPG, PNG, GIF, WebP',
    ...
    tip3: 'GIF / WebP は静止画として取り込みます（アニメは先頭フレーム）。',
  ...
  zh: {
    title: 'Img2PDF',
    subtitle: '将 JPG / PNG / GIF / WebP 转换为 PDF（单个/合并）',
    mode_merge: '合并',
    mode_single: '单个转换',
    drop_prompt: '将文件拖放到此处或点击选择',
    drop_supported: '支持: JPG, PNG, GIF, WebP',
